...
const IconTrophy = (props) => {
    return (
        <Svg height={props.height} width={props.width} version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" 
            viewBox="0 0 512 512">
            <G>
                <Path fill={props.fill} d="M102.49,0c0,27.414,0,104.166,0,137.062c0,112.391,99.33,156.25,153.51,156.25
                ...
                <Polygon fill={props.fill} points="315.473,400.717 291.681,367.482 279.791,318.506 256,322.004 232.209,318.506 220.314,367.482 
                    205.347,388.394 196.527,400.476 196.699,400.476 196.527,400.717 	"/>
                <Polygon fill={props.fill} points="366.93,432.24 366.93,432 145.07,432 145.07,511.598 145.07,511.76 145.07,511.76 145.07,512 
                    366.93,512 366.93,432.402 366.93,432.24 	"/>
                <Path fill={props.fill} d="M511.638,96.668c-0.033-1.268-0.068-2.336-0.068-3.174V45.1h-73.889v38.736h35.152v9.658
                ...
                <Path fill={props.fill} d="M60.625,167.955c-22.848-23.496-21.934-56.227-21.541-70.203c0.047-1.701,0.082-3.131,0.082-4.258v-9.658
